...
const contractAddress = "0xb71f583419adA3Cfc4957Fa6352A511Cb798c794";
    ...
    <div className="container mx-auto p-4 min-h-screen flex flex-col items-center bg-gray-900 text-white">
      ...
      <div className="grid grid-cols-1 gap-6 mt-6">
        {candidates.map((candidate, index) => (
          <div key={index} className="voter-tab">
            <span className="text-xl mb-2 text-center">{candidate.name}</span>
